...
Visiting `/api`:![](/src/assets/images/bookstore-tryhackme/api-docs.png)
...
Testing all parameters we found that `show` parameter is vulnerable!![](/src/assets/images/bookstore-tryhackme/etc-passwd-lfi.png)
...
This PIN will be useful on the console debug web page. Let's visit it:![](/src/assets/images/bookstore-tryhackme/console.png)
