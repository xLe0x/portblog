---
heroImage: public/images/bookstore-thm-banner.png
...
Visiting `/api`:![](/images/bookstore-tryhackme/api-docs.png)
...
Testing all parameters we found that `show` parameter is vulnerable!![](/images/bookstore-tryhackme/etc-passwd-lfi.png)
...
This PIN will be useful on the console debug web page. Let's visit it:![](/images/bookstore-tryhackme/console.png)
